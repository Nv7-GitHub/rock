...
int LSM9DS1Class::begin()
{
  ...
  writeRegister(LSM9DS1_ADDRESS, LSM9DS1_CTRL_REG6_XL, 0x68); // 119 Hz, 16g // CHANGED - was 4g, 0x70 before
...
int LSM9DS1Class::readAcceleration(float& x, float& y, float& z)
{
  ...
  // Changed from 4 to 24, but shouldn't it be 16?
  x = data[0] * 24.9 / 32768.0;
  y = data[1] * 24.9 / 32768.0;
  z = data[2] * 24.9 / 32768.0;
